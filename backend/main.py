...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://ai-summarizer-4id9365o3-mustafa-nafi-ugurs-projects.vercel.app"],  # Frontend'in erişmesine izin ver "https://ai-summarizer-2zvrghsyi-mustafa-nafi-ugurs-projects.vercel.app/" http://localhost:3000
